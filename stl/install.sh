#!/bin/bash
#stl (Wegare) - Repo Modified: donghuaaa
...
wget --no-check-certificate "https://raw.githubusercontent.com/donghuaaa/STL/main/stl/stl.sh" -O /usr/bin/stl
wget --no-check-certificate "https://raw.githubusercontent.com/donghuaaa/STL/main/stl/autorekonek-stl.sh" -O /usr/bin/autorekonek-stl
wget --no-check-certificate "https://raw.githubusercontent.com/donghuaaa/STL/main/stl/tunnel.py" -O /root/akun/tunnel.py
wget --no-check-certificate "https://raw.githubusercontent.com/donghuaaa/STL/main/stl/ssh.py" -O /root/akun/ssh.py
wget --no-check-certificate "https://raw.githubusercontent.com/donghuaaa/STL/main/stl/inject.py" -O /root/akun/inject.py
